...
public interface MaterialMenu {
    ...
    /**
     * Manually set a transformation value for an {@link cc.siyo.iMenu.VCheck.view.MaterialMenu.MaterialMenuDrawable.AnimationState}
     *
     * @param animationState state to set value in
     * @param value          between {@link cc.siyo.iMenu.VCheck.view.MaterialMenu.MaterialMenuDrawable#TRANSFORMATION_START} and
     *                       {@link cc.siyo.iMenu.VCheck.view.MaterialMenu.MaterialMenuDrawable#TRANSFORMATION_END}.
     */
