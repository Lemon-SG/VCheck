package cc.siyo.iMenu.VCheck.view.stiky_scrollview;
...
public class StickyScrollView extends ScrollView {
    ...
    private String TAG = "StickyScrollView";
...
//        Util.println(TAG, "showStickView");
...
//                    Util.println(TAG, "curStickyView == null");
					curStickyView = v;
				}
			} else {
//                Util.println(TAG, "topOffset >= 0");
