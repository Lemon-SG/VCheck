 ...
 * <li>{@link com.huassit.imenu.android.util.PackageUtils#installNormal(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link com.huassit.imenu.android.util.PackageUtils#uninstallNormal(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link com.huassit.imenu.android.util.PackageUtils#isSystemApplication(Context)}</li>
 * <li>{@link com.huassit.imenu.android.util.PackageUtils#isSystemApplication(Context, String)}</li>
 * <li>{@link com.huassit.imenu.android.util.PackageUtils#isSystemApplication(PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link com.huassit.imenu.android.util.PackageUtils#isTopActivity(Context, String)} whether the app whost package's name is packageName is on the
 * top of the stack</li>
 * <li>{@link com.huassit.imenu.android.util.PackageUtils#startInstalledAppDetails(Context, String)} start InstalledAppDetails Activity</li>
 * </ul>
 *
