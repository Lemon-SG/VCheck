    ...
    private class ReturnInfoViewHolder implements ViewHolder<ReturnInfo> {
        ...
        public void updateData(final ReturnInfo returnInfo, int position) {
            ...
            if (returnInfo.isTrue) {
                check_box
                        .setImageResource(R.drawable.ic_collect_red);
            } else {
                check_box.setImageResource(R.drawable.ic_collect_black);
            }
            layout_return_reason_list_item
                    .setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            check_box.setImageResource(R.drawable.ic_collect_red);
                            ((SubmitReturnActivity) context).changeBox(returnInfo);
//                            if (returnInfo.return_reason_name.equals("其他原因")) {
//                                ((ApplyReturnActivity) context).showEdit(true);
//                            } else {
//                                ((ApplyReturnActivity) context).showEdit(false);
//                            }
                        }
                    });
        }
